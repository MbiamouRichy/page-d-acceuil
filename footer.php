<footer class="footer-area section_gap">
    <div class="container">
        ...
        <div class="row footer-bottom d-flex justify-content-between">
            <p class="col-lg-8 col-sm-12 footer-text m-0 text-white">Copyright © 2022 Tous droits réservés | Ce modèle est fait avecpar
                 <i class="fas fa-heart-o" aria-hidden="true"></i> by <a href="#">kamfopen.</a><br><a href="#">az</a></p>
